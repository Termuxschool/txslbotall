...
cr = '*ANKER*'
vz = '*Terima Kasih Sudah Daftar Di TXSL BOT*'
const vcard = 'BEGIN:VCARD\n' // JAN DI UBAH
            ...
            + 'END:VCARD'
prefix = '#'
blocked = ['6282347594640@s.whatsapp.net']
		...
		try {
			...
			mess = {
				...
				only: {
					...
					benned: 'Anda terkena Band Silahkan Hub Owner wa.me/6281368646011',
...
const koin = ['http://bit.ly/Koin1','http://bit.ly/Koin5','https://i.ibb.co/q7kdBjm/be27e6f849da.jpg','https://i.ibb.co/BCxNPD5/a42ef753a321.jpg']
			...
			const ownerNumber = ["6282347594640@s.whatsapp.net","6282347594640@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["6282347594640@s.whatsapp.net"]
			const frendsowner = ["6282347594640@s.whatsapp.net"]
			const vip = ["6282347594640@s.whatsapp.net","6282347594640@s.whatsapp.net"]
